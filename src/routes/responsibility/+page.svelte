												...
												<td class="py-3 px-4">
													<div class="flex space-x-2">
														<button
															...
															aria-label="Edit responsibility {responsibility.category} - {responsibility.subCategory}"
														>
														...
														<button
															...
															aria-label="Delete responsibility {responsibility.category} - {responsibility.subCategory}"
														>
															<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
