...
async function seedDatabase() {
	...
	console.log('✅ Created sample users');
		...
		await db.communicationMessage.createMany({
			data: [
		...
		await db.communicationWishList.createMany({
			data: [
		...
		await db.communicationSuggestion.createMany({
			data: [
		...
		await db.communicationDiscussion.createMany({
			data: [
		...
		await db.learningCourse.createMany({
			data: [
		...
		await db.learningTeachingLog.createMany({
			data: [
		...
		await db.learningStudyMaterial.createMany({
			data: [
		...
		const learningDuty = await db.learningDuty.create({
			data: {
